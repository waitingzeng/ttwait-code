...
namespace TTwait
{
    ...
    public class RASDisplay
    {
        ...
        public int Connect(string Connection)
        {
            ...
            uint INTERNET_AUTODIAL_FORCE_ONLINE = 1;
            uint INTERNET_AUTODIAL_FORCE_UNATTENDED = 2;
            int retVal = RAS.InternetDial(IntPtr.Zero, Connection, INTERNET_AUTODIAL_FORCE_UNATTENDED,
            ref temp, 0);
            return retVal;
        }
        ...
        public void ReNew(string Connection)
        {
            this.Disconnect();
