...
function doSubmit(action)
{
    if (action == 'crop')
    {
        var url = "editorFrame.php?img="+currentImageFile+"&b="+bJS+"&p="+pJS+"&action=crop&params="+parseInt(t_cx.value)+','+parseInt(t_cy.value)+','+ parseInt(t_cw.value)+','+parseInt(t_ch.value);
    ...
    {
        var url = "editorFrame.php?img="+currentImageFile+"&b="+bJS+"&p="+pJS+"&action=scale&params="+parseInt(s_sw.value)+','+parseInt(s_sh.value);
        //alert(url);
        location.href = url;
    ...
    else if (action == 'rotate')
    {
        ...
        if(flip.value == 'hoz' || flip.value == 'ver') 
            location.href = "editorFrame.php?img="+currentImageFile+"&b="+bJS+"&p="+pJS+"&action=flip&params="+flip.value;
        else if (isNaN(parseFloat(r_ra.value))==false)
            location.href = "editorFrame.php?img="+currentImageFile+"&b="+bJS+"&p="+pJS+"&action=rotate&params="+parseFloat(r_ra.value);
    }
    else if(action == 'save') {
        ...
        else
        {
            ...
            var url = "editorFrame.php?img="+currentImageFile+"&b="+bJS+"&p="+pJS+"&action=save&params="+format[0]+","+quality+"&file="+filename;
            //alert(url);
            location.href = url;
        }
    }
