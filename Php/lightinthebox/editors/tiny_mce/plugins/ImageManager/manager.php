...
/*<![CDATA[*/
	...
	function goToRootDir() {
		top.frames["imgManager"].location = "images.php?b="+baseurl+"&p="+basepath;
	}
/*]]>*/
</script>
...
<? } ?>
	...
	<a href="#" onclick="goToRootDir();" title="Directory Up"><img src="img/btnFolderUp.gif" height="15" width="15" alt="Directory Up" /></a>
...
<? } ?>
	...
	<iframe src="images.php?b=<?=$_GET[b]?>&p=<?=$_GET[p]?>" name="imgManager" id="imgManager" class="imageFrame" scrolling="auto" title="Image Selection" frameborder="0"></iframe>
</div>
</fieldset>
<!-- image properties -->
...
<? if($IMConfig['allow_upload'] == true) { ?>
			<td align="right"><label for="upload">Upload <br />
			<strong><? echo ($IMConfig['max_size']/1024/1024); ?> MB max.</strong></label></td>
			<td>
