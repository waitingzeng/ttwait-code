	...
	function selectClick() {
		if (validateParams()) {	
			if (document.forms[0].src.value !='') {		
				...
				// tinymce 2.0.5.1 * fix * 
	                        window.opener.TinyMCE_AdvancedTheme._insertImage(src, alt, border, hspace, vspace, width, height, align, title);
...
<form name="libbrowser" id="libbrowser" method="post" action="ibrowser.php?request_uri=<?php echo $_GET['request_uri']?>" enctype="multipart/form-data" target="imglibrary">
            ...
            <td colspan="3"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="40%"><?php if ($tinyMCE_img_delete_allowed) { ?>
                    ...
                    <?php } ?></t                  ><td align="right"><input type="button" name="selectbt" value="{$lang_ibrowser_select}" class="bt" onClick="selectClick();">
