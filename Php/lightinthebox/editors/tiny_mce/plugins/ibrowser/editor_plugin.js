...
function TinyMCE_ibrowser_getControlHTML(control_name) {
	switch (control_name) {
		case "ibrowser":
			return '<a class="mceTiledButton mceButtonNormal" id="{$editor_id}_ibrowser" onclick="tinyMCE.execInstanceCommand(\'{$editor_id}\',\'mceBrowseImage\');return false;" href="tinyMCE.execInstanceCommand(\'{$editor_id}\',\'mceBrowseImage\');return false;"><img id="{$editor_id}_ibrowser23" src="{$pluginurl}/images/ibrowser.gif" title="{$lang_ibrowser_desc}" width="20" height="20"></a>';
	}
