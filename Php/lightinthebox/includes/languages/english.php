...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. All Rights Reserved.<br/>
<a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">Buy wholesale</a> products at <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">wholesale</a> price from leading Chinese <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">wholesalers</a>, enjoy <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">online wholesale</a> and become a <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">wholesaler</a> now!<br/><h1 class="big gray b_ g_t_c" >China wholesale, wholesale from China, buy wholesale products from Chinese wholesaler</h1>'); 
