...
// Custom Keywords
define('CUSTOM_KEYWORDS', 'Wholesale - China Wholesale - Buy Wholesale Products from Chinese Wholesaler.');

// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'Reliable and professional China wholesale website where you can buy wholesale merchandise and dropship them anywhere in the world!');
  define('HOME_PAGE_META_KEYWORDS', 'wholesale, China wholesale, Wholesaler');
  define('HOME_PAGE_TITLE', 'Wholesale - China Wholesale - Buy Wholesale Products from Chinese Wholesaler');
