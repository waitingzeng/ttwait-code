...
//
  ...
  define('MODULE_PAYMENT_WESTERNUNION_RECEIVER_NOTICE', ' PLEASE EMAIL YOUR ORDER NUMBER ,THE WESTERN UNION CONTROL NUMBER,AMOUNT,SENDER\'S FIRST AND LAST NAME,SENDER\'S ADDRESS AND COUNTRY,SENDER\'S PHONE NUMBER TO '.'loveweshop@gmail.com'.' AFTER YOUR SEND PAYMENT BY WESTERN UNION. THANKS!');
  ...
  define('MODULE_PAYMENT_WESTERNUNION_MARK_BUTTON_IMG', 'includes/templates/loveweshop/images/checkout/pic_3.jpg');
