...
<?php if (DISPLAY_LINK_CATEGORIES_AS_IMAGES == 'true') { ?>
  <tr>
<?php
...
<?php } else {   while (!$categories_query->EOF) { $lPath_new = 'lPath=' . $categories_query->fields['link_categories_id']; ?>
          <tr>
            <td colspan="2"><a href="<?php echo zen_href_link(FILENAME_LINKS, $lPath_new); ?>"><?php echo $categories_query->fields['link_categories_name']; ?></a></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo $categories_query->fields['link_categories_description']; ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
          </tr>

<?php $categories_query->MoveNext(); } } ?>
              ...
              <tr class="infoBoxContents">
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
					...
					<?php if (ALLOW_LINKS_SUBMISSION == 'true') { ?><?php echo '<a href="' . zen_href_link(FILENAME_LINKS_SUBMIT, zen_get_all_get_params()) . '">' . zen_image_button('button_submit_link.gif', IMAGE_BUTTON_SUBMIT_LINK) . '</a>'; ?><?php } ?></td>
                    <td width="10"><?php echo zen_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                  </tr>
                </table></td>
              </tr>
    ...
    for ($i=0, $n=sizeof($column_list); $i<$n; $i++) {
      switch ($column_list[$i]) {
        ...
        case 'LINK_LIST_COUNT':
          ...
          break;
		case 'LINK_LIST_EDIT':
          $select_column_list .= 'l.links_owner, ';
          break;
      }
    }
    ...
    if ( (!isset($_GET['sort'])) || (!ereg('[1-8][ad]', $_GET['sort'])) || (substr($_GET['sort'], 0, 1) > sizeof($column_list)) ) {
      ...
      switch ($column_list[$sort_col-1]) {
        ...
        case 'LINK_LIST_COUNT':
          ...
          break;
        case 'LINK_LIST_EDIT':
          $listing_sql .= "l.links_owner " . ($sort_order == 'd' ? 'desc' : '') . ", ld.links_title";
          break;
      }
    }
?>
<table  width="100%" border="0" cellspacing="2" cellpadding="2" class="centerColumn">
  ...
  <tr>
    <td class="pageHeading" colspan="2"><h1><?php echo $link_categories_query->fields['link_categories_name']; ?></h1></td>
  </tr>
      <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td width="10"><?php echo zen_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main" align="right"><?php if (ALLOW_LINKS_SUBMISSION == 'true') { ?><?php echo '<a href="' . zen_href_link(FILENAME_LINKS_SUBMIT, zen_get_all_get_params()) . '">' . zen_image_button('button_submit_link.gif', IMAGE_BUTTON_SUBMIT_LINK) . '</a>'; ?><?php } ?></td>
                <td width="10"><?php echo zen_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>
