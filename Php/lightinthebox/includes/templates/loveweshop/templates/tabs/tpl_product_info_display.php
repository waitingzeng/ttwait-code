...
?>
	...
	<style type="text/css" media="screen">@import "../../../loveweshop/templates/tabs/tabs/basic.css";</style>
	<style type="text/css" media="screen">@import "../../../loveweshop/templates/tabs/tabs/tabs.css";</style>
...
<div id="header">
	<ul id="primary">
		...
		<li><a href="../../../loveweshop/templates/tabs/tabs/about.html">About Us</a></li>
		<li><a href="../../../loveweshop/templates/tabs/tabs/portfolio.html">Our Portfolio</a></li>
		<li><a href="../../../loveweshop/templates/tabs/tabs/contact.html">Contact Us</a></li>
	</ul>
	</div>
	<div id="main">
		<div id="contents">
...
<a target="_blank" title="Print Page" href="<?php echo '../../../loveweshop/templates/tabs/print_page_p'.$_GET['products_id'];?>">Print Page</a>
</div>
...
<a name="review"></a><h2 class="margin_t blue">Write a Review:</h2>
	...
	<table width="360" border="0" class="big">
	  ...
	  <tr><td colspan="2">
		  ...
		  <td>
		  <div onmousedown="rating.startSlide()" onmousemove="rating.doSlide(event)" onmouseout="rating.resetHover()" onclick="rating.setRating(event)" onmouseup="rating.stopSlide()" id="r_RatingBar" style="background: transparent url(../../../loveweshop/templates/tabs/includes/templates/loveweshop/images/icon/unfilled.gif) repeat scroll 0%; width: 75px; cursor: pointer; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial;">
			<div style="background: transparent url(../../../loveweshop/templates/tabs/includes/templates/loveweshop/images/icon/hover.gif) repeat-x scroll 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; height: 14px; width: 0px;" id="r_Hover">
			<div id="r_Filled" style="background: transparent url(../../../loveweshop/templates/tabs/includes/templates/loveweshop/images/icon/sparkle.gif) repeat-x scroll 0%; overflow: hidden; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; height: 14px; width: 60px;"></div>
			</div>
		</div>
		</td>
