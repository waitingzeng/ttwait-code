...
<h2 class="border_b line_30px">Specials</h2>
<br class="clear" />

<?php
  if (($products_new_split->number_of_rows > 0) && ((PREV_NEXT_BAR_LOCATION == '1') || (PREV_NEXT_BAR_LOCATION == '3'))) {
?>
<div class="pagebar border_b gray_bg"><span class="fl"><?php echo $products_new_split->display_count(TEXT_DISPLAY_NUMBER_OF_SPECIALS); ?></span><ul class="fr"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_drop_down(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?></ul></div>
<?php
  }
?>
<div class="list_bar">
    <ul>
      ...
      <?php switch($listTypes){
        ...
        <a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'listtypes=2').cleanSameArgNoHtml('listtypes');?>"><span class="list_grid">Grid</span></a>    
        <a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'listtypes=3').cleanSameArgNoHtml('listtypes');?>"><span class="list_gallery">Gallery</span></a>    
      <?php break;
                case '2':?>
        <a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'listtypes=1').cleanSameArgNoHtml('listtypes');?>"><span class="list_list">List</span></a>
      ...
      <span class="category">
      <a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'display=2').cleanSameArgNoHtml('display');?>">   Wholesale Only
      </a>    </span>       
      <span class="category">
      <a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'display=3').cleanSameArgNoHtml('display');?>">    Free Shipping
      </a>    </span>
      <?php break;
      case '2':?>
      <span class="category"><a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'display=1').cleanSameArgNoHtml('display');?>">ALL</a></span>
      ...
      case '3':?>
      <span class="category"><a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'display=1').cleanSameArgNoHtml('display');?>">ALL</a></span>
      <span class="category"><a href="<?php echo zen_href_link(FILENAME_SPECIALS, 'display=2').cleanSameArgNoHtml('display');?>">Wholesale Only</a></span>       
