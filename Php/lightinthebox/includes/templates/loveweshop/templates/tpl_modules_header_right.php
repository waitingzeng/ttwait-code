  ...
  <ul>
    ...
    <li><a class="two outer" rel="nofollow" target="_top" href="<?php echo zen_href_link(FILENAME_FAQS,'','SSL')?>">Help
      ...
      <div class="tab_center">
        <p><a target="_top" rel="nofollow" href="<?php echo zen_href_link(FILENAME_FAQS); ?>">Sumbit a Request</a></p>
        <p><a target="_top" rel="nofollow" href="<?php echo zen_href_link(FILENAME_FAQS_ALL) ?>">Help Center</a></p>
      </div>
      <!--[if lte IE 6]></td></tr></table></a><![endif]-->
    </li>
