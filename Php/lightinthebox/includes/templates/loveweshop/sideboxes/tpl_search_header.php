 ...
 */
  ...
  $content .= zen_draw_pull_down_menu('categories_id', $categories_array,'','class="select" id="light_select"').'</li><li>';
	$content .= zen_draw_input_field('keyword', '', 'class ="input" id="keyword" value="' . HEADER_SEARCH_DEFAULT_TEXT . '" onfocus="if (this.value == \'' . HEADER_SEARCH_DEFAULT_TEXT . '\') this.value = \'\';" onblur="if (this.value == \'\') this.value = \'' . HEADER_SEARCH_DEFAULT_TEXT . '\';"') . '</li><li><a class="btn_search" onclick="if($(\'keyword\').value==\'Enter search keywords here\'){alert(\'Please submit the keyword!\');}else{$(\'quick_find_header\').submit();}return false;" href="javascript:void(0);"></a></li></ul>'; 
