...
<div style="position: relative; z-index: 200; height: 70px; float: left;" id="menu_btn">
	<span id="litbBtn" style="DISPLAY: block; Z-INDEX: 11; BACKGROUND: url(../../loveweshop/common/includes/templates/loveweshop/images/menu_arrow.gif) no-repeat; LEFT: 154px; OVERFLOW: hidden; WIDTH: 16px; CURSOR: pointer; POSITION: absolute; TOP: 18px; HEIGHT: 17px"></span>
