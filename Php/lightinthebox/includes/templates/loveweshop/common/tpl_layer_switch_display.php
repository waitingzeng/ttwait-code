...
<div title="BestDeal" class="on"><a href="<?php echo zen_href_link(FILENAME_BEST_DEAL,'productsort=1','SSL') ?>"><span><?php if ($specials_title) {echo $specials_title;} ?></span></a></div>
<div title="FreeShipping" id="border_left" class="off"><a href="<?php echo zen_href_link(FILENAME_FREE_SHIPPING,'display=3','SSL') ?>"><span><?php if ($free_title) {echo $free_title;} ?></span></a></div>
<div title="NewArrivals" id="border_left" class="off"><a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW,'productsort=5','SSL') ?>"><span><?php if ($title) {echo $title;} ?></span></a></div>			
</div>
