          ...
          where    patrib.products_id='" . (int)$_GET['products_id'] . "'
            ...
            if ($pr_attr->fields['total'] > 0) {
              ...
              if ( PRODUCTS_OPTIONS_SORT_BY_PRICE =='1' ) {
                ...
                //$order_by= ' order by LPAD(pov.products_options_values_name,11,"0")';
              } else {
              ...
              and       pov.language_id = '" . (int)$_SESSION['languages_id'] . "' " .
                ...
                while (!$products_options->EOF) {
                  ...
                  $products_options_array[sizeof($products_options_array)-1]['price'] = $new_attributes_price;
...
//                        $selected_attribute = ($products_options->fields['attributes_default']=='1' ? true : false);
                ...
                switch (true) {
                  ...
                  $options_menu[] = zen_draw_pull_down_menu('id[' . $products_options_names->fields['products_options_id'] . ']', $products_options_array, $selected_attribute, 'options_name="'.$products_options_names->fields['products_options_name'].'" id="' . 'attrib-' . $products_options_names->fields['products_options_id'] . '" style="border: 1px solid #ddd; width: 150px;"') . "\n";
                  $options_comment[] = $products_options_names->fields['products_options_comment'];
                  $options_comment_position[] = ($products_options_names->fields['products_options_comment_position'] == '1' ? '1' : '0');
                  break;
                }
