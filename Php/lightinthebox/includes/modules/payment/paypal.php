...
//      $optionsLineItems['num_cart_items'] = sizeof($order->products);
	...
	//global $orders_id;
	$paypal_order_id = date('YmdHis').rand(10,20);//zen_get_order_no($orders_id);
    $optionsAggregate = array(
                   'cmd' => '_ext-enter',
                   'item_name' => MODULE_PAYMENT_PAYPAL_ORDER_ID_PREFIX . $paypal_order_id,//MODULE_PAYMENT_PAYPAL_PURCHASE_DESCRIPTION_TITLE,
