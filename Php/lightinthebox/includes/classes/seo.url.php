      ...
      if ($use_dir_ws_catalog) {
		...
		function stock_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = true, $search_engine_safe = true, $static = false, $use_dir_ws_catalog = true) {
			...
			if (!$this->not_null($page)) {
				die('</td></tr></table></td></tr></table><br /><br /><strong class="note">Error!<br /><br />No es posible determinar el enlace de la p�gina!</strong><br /><br />');
			}
			...
			if ($connection == 'NONSSL') {
				...
				die('</td></tr></table></td></tr></table><br /><br /><strong class="note">Error!<br /><br />No es posible determinar el m�todo de conexi�n en un v�nculo!<br /><br />M�todos conocidos: NONSSL SSL</strong><br /><br />');
			}
