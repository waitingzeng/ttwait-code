...
if ((isset($_POST['localfile']) or $_GET['split']==2) or ((isset($_FILES['usrfl']) or isset($GLOBALS[$usrfl . '_name'])) && $_GET['split']==0)) {
	...
	foreach ($readed as $file_row) {
		...
		// $items = preg_split($pattern, $file_row);
							...
							<table width="70%" border="0" cellpadding="8" valign="top">
								<tr>
									<td width="100%">
										<p>
											...
											<form ENCTYPE="multipart/form-data" ACTION="easypopulate.php?split=2" METHOD="POST">
												<div align = "left">
													...
													<input name="usrfl" type="file" size="50">
													<input type="submit" name="buttonsplit" value="分割文件">
													<br />
												</div>
											</form>
										...
										<a href="easypopulate.php?download=stream&dltype=full">下载 <b>完整的</b> 以TAB分割的文本文件</a>
...
<?php } ?>
										<br />
										<a href="easypopulate.php?download=stream&dltype=priceqty">下载 <b>型号/价格/数量</b> 以TAB分割的文本文件</a><br />
										<a href="easypopulate.php?download=stream&dltype=category">下载 <b>型号/分类</b> 以TAB分割的文本文件</a><br />
										<a href="easypopulate.php?download=stream&dltype=froogle">下载 <b>Froogle</b> 以TAB分割的文本文件</a><br />
										<a href="easypopulate.php?download=stream&dltype=attrib">下载 <b>型号/属性</b> 以TAB分割的文本文件</a>
										<br /><br />
										<b>在临时目录中创建批量和Froogle文件 (<? echo $tempdir; ?>)</b>
										<br /><br />
										<a href="easypopulate.php?download=tempfile&dltype=full">在临时目录中创建 <b>完整的</b> 以TAB分割的文本文件</a>
<?php if ($products_with_attributes == true) { ?>
										<span class="fieldRequired"> (包含属性)</span>
<?php } else { ?>
										<span class="fieldRequired"> (不含属性)</span>
<?php } ?>
										<br />
										<a href="easypopulate.php?download=tempfile&dltype=priceqty">在临时目录中创建 <b>型号/价格/数量</b> 以TAB分割的文本文件</a><br />
										<a href="easypopulate.php?download=tempfile&dltype=category">在临时目录中创建 <b>型号/分类</b> 以TAB分割的文本文件</a><br />
										<a href="easypopulate.php?download=tempfile&dltype=froogle">在临时目录中创建 <b>Froogle</b> 以TAB分割的文本文件</a><br />
										<a href="easypopulate.php?download=tempfile&dltype=attrib">在临时目录中创建 <b>型号/属性</b> 以TAB分割的文本文件</a><br />
									</td>
								</tr>
							</table>
<?php
