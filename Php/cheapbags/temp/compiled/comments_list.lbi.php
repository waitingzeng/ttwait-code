<div class="GoodTagTit clearfix blank">
<h2><?php echo $this->_var['lang']['user_comment']; ?></h2>
</div>
...
?>
 ...
 <?php endif; ?>
  给出 <img src="themes/EnTemplate/images/stars<?php echo $this->_var['comment']['rank']; ?>.gif" alt="<?php echo $this->_var['comment']['comment_rank']; ?>" /> 评分
      ...
      <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
       <table border="0" cellspacing="5" cellpadding="0">
        ...
        <tr>
          ...
          <td>
          <input type="text" name="email" id="email"  maxlength="100" value="<?php echo htmlspecialchars($_SESSION['email']); ?>" class="InBorder"/>
          </td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['comment_rank']; ?>：</td>
          <td>
          <input name="comment_rank" type="radio" value="1" id="comment_rank1" /> <img src="themes/EnTemplate/images/stars1.gif" />
          <input name="comment_rank" type="radio" value="2" id="comment_rank2" /> <img src="themes/EnTemplate/images/stars2.gif" />
          <input name="comment_rank" type="radio" value="3" id="comment_rank3" /> <img src="themes/EnTemplate/images/stars3.gif" />
          <input name="comment_rank" type="radio" value="4" id="comment_rank4" /> <img src="themes/EnTemplate/images/stars4.gif" />
          <input name="comment_rank" type="radio" value="5" checked="checked" id="comment_rank5" /> <img src="themes/EnTemplate/images/stars5.gif" />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <?php echo $this->_var['lang']['comment_captcha']; ?>：<input type="text" name="captcha" size="10"  class="InBorder"/>
          <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" onClick="this.src='captcha.php?'+Math.random()">
          </div>
          <?php endif; ?>
          <input name="" type="submit"  value="<?php echo $this->_var['lang']['submit_comment']; ?>" class="bnt_number4 f_r">
          </td>
        </tr>
      </table>
      </form>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_70517400_1300168280');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_70517400_1300168280']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_70517400_1300168280']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
