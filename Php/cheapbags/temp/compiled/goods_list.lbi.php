<div class="goodsTitle clearfix blank">
  <h2 class="f_l">View : &nbsp;&nbsp;</h2>
  <form method="GET" class="sort" name="listform">
  
  <a href="javascript:;" onClick="javascript:display_mode('list')" title="Display By List"><img src="themes/EnTemplate/images/display_mode_list<?php if ($this->_var['pager']['display'] == 'list'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['list']; ?>"></a>
  <a href="javascript:;" onClick="javascript:display_mode('grid')" title="Display By Grid"><img src="themes/EnTemplate/images/display_mode_grid<?php if ($this->_var['pager']['display'] == 'grid'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['grid']; ?>"></a>
  <a href="javascript:;" onClick="javascript:display_mode('text')" title="Display By Text"><img src="themes/EnTemplate/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a> &nbsp;&nbsp;

  <select name="sort" class="text">
        <?php echo $this->html_options(array('options'=>$this->_var['lang']['sort'],'selected'=>$this->_var['pager']['sort'])); ?>
      </select>
      <select name="order" class="text">
        <?php echo $this->html_options(array('options'=>$this->_var['lang']['order'],'selected'=>$this->_var['pager']['order'])); ?>
      </select>
      <input name="imageField" type="submit" value="" class="goto"  /> 
...
?>
  ...
  <a href="javascript:;" id="compareLink" onClick="Compare.add(<?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>','<?php echo $this->_var['goods']['type']; ?>')"><img src="themes/EnTemplate/images/btn-db.gif" / ></a>
    </li>
    </ul>
