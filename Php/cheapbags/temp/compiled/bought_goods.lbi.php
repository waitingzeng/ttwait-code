...
<h2><?php echo $this->_var['lang']['shopping_and_other']; ?></h2>
</div>
...
?>
 ...
 <b class="PriceTwo"><?php echo $this->_var['bought_goods_data']['formated_promote_price']; ?></b><br>
 <?php else: ?>
  <b class="PriceTwo"><?php echo $this->_var['bought_goods_data']['shop_price']; ?></b><br>
 <?php endif; ?>
 </div>
