 ...
 <h4><?php echo $this->_var['lang']['label_login']; ?></h4>
  <form name="formLogin" action="user.php" method="post" onsubmit="return userLogin()">
    <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
      ...
      if you forgot you password, you can reset it from：<br />
      <a href="user.php?act=qpassword_name"><?php echo $this->_var['lang']['get_password_by_question']; ?></a><br />
      </div>
      ...
      document.getElementById("tips").style.display = "none";
          ...
          <tr>
            ...
            <td align="left"><input type="text" size="8" name="captcha" class="InBorderTwo" />
  ...
  <form action="user.php" method="post" name="formUser" onsubmit="return register();">
      <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
        <tr>
          ...
          <input name="username" type="text" size="25" id="username" onblur="is_registered(this.value);" class="InBorderTwo"/>
        ...
        <tr>
          ...
          <td>
          <input name="email" type="text" size="25" id="email" onblur="checkEmail(this.value);"  class="InBorderTwo"/>
        ...
        <tr>
          ...
          <td>
          <input name="password" type="password" id="password1" onblur="check_password(this.value);" onkeyup="checkIntensity(this.value)" class="InBorderTwo" style="width:179px;" />
        ...
        <tr>
          ...
          <td>
          <input name="confirm_password" type="password" id="conform_password" onblur="check_conform_password(this.value);"  class="InBorderTwo" style="width:179px;"/>
...
?>
 <?php if ($this->_var['field']['id'] == 6): ?>
        <tr>
          ...
          <td>
          <select name='sel_question' class="InBorderTwo">
     ...
     <?php echo $this->html_options(array('options'=>$this->_var['passwd_questions'])); ?>
        ...
        <tr>
          ...
          <td>
   <input name="passwd_answer" type="text" size="25" class="InBorderTwo" maxlengt='20'/><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
          </td>
        </tr>
 <?php else: ?>
        <tr>
          ...
          <td>
          <input name="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" size="25" class="InBorderTwo" /><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
          </td>
        </tr>
 <?php endif; ?>
 <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <tr>
      <td align="right"><?php echo $this->_var['lang']['comment_captcha']; ?></td>
      <td><input type="text" size="8" name="captcha" class="InBorderTwo" />
      ...
      <?php endif; ?>
        ...
        <tr>
          <td>&nbsp;</td>
          <td class="actionSub">
          <a href="user.php?act=login" class="Triangle"><?php echo $this->_var['lang']['want_login']; ?></a><br />
          </td>
        </tr>
      </table>
    </form>
    ...
    <form action="user.php" method="post" name="getPassword" onsubmit="return submitPwdInfo();">
     <table width="100%" border="0" align="center" cellpadding="5">
          ...
          <tr>
            ...
            <td width="60%"><input name="user_name" type="text" size="30" class="InBorderTwo" /></td>
          </tr>
          <tr>
            <td align="right"><?php echo $this->_var['lang']['email']; ?></td>
            <td><input name="email" type="text" size="30" class="InBorderTwo" /></td>
          </tr>
          <tr>
            <td></td>
            <td>
    ...
    <form action="user.php" method="post">
     <table width="100%" border="0" align="center" cellpadding="5">
          ...
          <tr>
            ...
            <td><input name="passwd_answer" type="text" size="20" class="InBorderTwo" /></td>
          </tr>
          <?php if ($this->_var['enabled_captcha']): ?>
          <tr>
            <td align="right"><?php echo $this->_var['lang']['comment_captcha']; ?></td>
    ...
    <form action="user.php" method="post" name="getPassword2" onsubmit="return submitPwd()">
      <table width="100%" border="0" align="center" cellpadding="5">
        <tr>
          ...
          <td width="60%"><input name="new_password" type="password" size="25" class="InBorderTwo" /></td>
        </tr>
        <tr>
          <td align="right"><?php echo $this->_var['lang']['confirm_password']; ?></td>
          <td><input name="confirm_password" type="password" size="25"  class="InBorderTwo"/></td>
        </tr>
        <tr>
