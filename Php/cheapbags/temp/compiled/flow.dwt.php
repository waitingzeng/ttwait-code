...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['goods_list']; ?></div>
...
?>
   <tr>
    <td bgcolor="#ffffff" align="center">
     ...
     <a href="javascript:void(0)" onclick="setSuitShow(<?php echo $this->_var['goods']['goods_id']; ?>)" class="f6"><?php echo $this->_var['goods']['goods_name']; ?><span style="color:#FF0000;">（<?php echo $this->_var['lang']['remark_package']; ?>）</span></a> <img src="themes/EnTemplate/images/package.gif" />
...
?>
    ...
    <td align="center" bgcolor="#ffffff">
     ...
     <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="InBorderTwo"  onkeydown="showdiv(this)"/>
     <?php else: ?>
     <?php echo $this->_var['goods']['goods_number']; ?>
     <?php endif; ?>
    </td>
    <td align="center" bgcolor="#ffffff" class="PriceTwo"><?php echo $this->_var['goods']['subtotal']; ?></td>
    <td align="center" bgcolor="#ffffff">
 ...
 <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" class="floatTable">
  <tr>
   <td><a href="./"><img src="themes/EnTemplate/images/continue.gif" /></a></td>
   <td align="right"><a href="flow.php?step=checkout"><img src="themes/EnTemplate/images/checkout.gif" /></a></td>
  </tr>
 </table>
 <?php if ($_SESSION['user_id'] > 0): ?>
...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['label_collection']; ?></div>
<div class="blank">
...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['goods_fittings']; ?></div>
 <form action="flow.php" method="post">
  <div class="clearfix topic blank">
...
?>
    ...
    <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/EnTemplate/images/btn-buy.gif" /></a>
   </div>
   <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  </div>
 </form>
...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['label_favourable']; ?></div>
...
?><br />
      ...
      <a href="goods.php?id=<?php echo $this->_var['gift']['id']; ?>" target="_blank"><?php echo $this->_var['gift']['name']; ?></a> <font class="red">[<?php echo $this->_var['gift']['formated_price']; ?>]</font>
     <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php endif; ?>
    </td>
   </tr>
...
<span class="f_l"><?php echo $this->_var['lang']['goods_list']; ?></span><?php if ($this->_var['allow_edit_cart']): ?><a href="flow.php" class="f_r"><?php echo $this->_var['lang']['modify']; ?></a><?php endif; ?>
</div>
...
?>
   ...
   <?php endif; ?>
   <td bgcolor="#ffffff" align="center"  class="PriceTwo"><?php echo $this->_var['goods']['formated_goods_price']; ?></td>
   <td bgcolor="#ffffff" align="center"><?php echo $this->_var['goods']['goods_number']; ?></td>
   <td bgcolor="#ffffff" align="center"  class="PriceTwo"><?php echo $this->_var['goods']['formated_subtotal']; ?></td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
<div class="goodsTitle clearfix blank">
<span class="f_l"><?php echo $this->_var['lang']['consignee_info']; ?></span><a href="flow.php?step=consignee" class="f_r"><?php echo $this->_var['lang']['modify']; ?></a>
</div>
<table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e3e3e3" class="blank">
  <tr>
...
<?php if ($this->_var['total']['real_goods_count'] != 0): ?>
<div class="goodsTitle blank"><?php echo $this->_var['lang']['shipping_method']; ?></div>
...
?>
  <tr>
   ...
   <td bgcolor="#ffffff" align="center" valign="top" class="username"><?php echo $this->_var['shipping']['format_shipping_fee']; ?></td>
   <td bgcolor="#ffffff" align="center" valign="top" class="username"><?php echo $this->_var['shipping']['free_money']; ?></td>
...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['payment_method']; ?></div>
...
?>
  ...
  <tr>
   ...
   <td align="center" bgcolor="#ffffff" valign="top" class="username"><?php echo $this->_var['payment']['format_pay_fee']; ?></td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
 </table>
<?php else: ?>
...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['goods_package']; ?></div>
...
?>
  <tr>
   ...
   <td valign="top" bgcolor="#ffffff" align="center" class="username"><?php echo $this->_var['pack']['format_pack_fee']; ?></td>
   <td valign="top" bgcolor="#ffffff" align="center" class="username"><?php echo $this->_var['pack']['format_free_money']; ?></td>
...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['goods_card']; ?></div>
...
?>
  <tr>
   ...
   <td valign="top" align="center" bgcolor="#ffffff" class="username"><?php echo $this->_var['card']['format_card_fee']; ?></td>
   <td valign="top" align="center" bgcolor="#ffffff" class="username"><?php echo $this->_var['card']['format_free_money']; ?></td>
  ...
  <tr>
   ...
   <td bgcolor="#ffffff" colspan="3"><textarea name="card_message" cols="60" rows="3"  class="InBorderTwo"><?php echo htmlspecialchars($this->_var['order']['card_message']); ?></textarea></td>
  </tr>
 </table>
<?php endif; ?>

<div class="goodsTitle blank"><?php echo $this->_var['lang']['other_info']; ?></div>
<table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#e3e3e3" class="blank">
  <?php if ($this->_var['allow_use_surplus']): ?>
  <tr>
   <td width="20%" bgcolor="#ffffff"><strong><?php echo $this->_var['lang']['use_surplus']; ?>: </strong></td>
   <td bgcolor="#ffffff"><input name="surplus" type="text"  class="InBorderTwo" id="ECS_SURPLUS" size="10" value="<?php echo empty($this->_var['order']['surplus']) ? '0' : $this->_var['order']['surplus']; ?>" onblur="changeSurplus(this.value)" <?php if ($this->_var['disable_surplus']): ?>disabled="disabled"<?php endif; ?> />
  ...
  <tr>
   ...
   <td bgcolor="#ffffff"><input name="integral" type="text"  class="InBorderTwo" id="ECS_INTEGRAL" onblur="changeIntegral(this.value)" value="<?php echo empty($this->_var['order']['integral']) ? '0' : $this->_var['order']['integral']; ?>" size="10" />
  ...
  <tr>
   ...
   <td bgcolor="#ffffff">
    ...
    <select name="bonus" onchange="changeBonus(this.value)" id="ECS_BONUS"  class="InBorderTwo">
...
?>
    ...
    <input name="bonus_sn" type="text"  class="InBorderTwo" size="15" value="<?php echo $this->_var['order']['bonus_sn']; ?>" />
  ...
  <tr>
   ...
   <td bgcolor="#ffffff">
    ...
    <select name="inv_type" id="ECS_INVTYPE" <?php if ($this->_var['order']['need_inv'] != 1): ?>disabled="true"<?php endif; ?> onchange="changeNeedInv()"  class="InBorderTwo">
    ...
    <input name="inv_payee" type="text"  class="InBorderTwo" id="ECS_INVPAYEE" size="20" <?php if (! $this->_var['order']['need_inv']): ?>disabled="true"<?php endif; ?> value="<?php echo $this->_var['order']['inv_payee']; ?>" onblur="changeNeedInv()" />
    <?php echo $this->_var['lang']['invoice_content']; ?>
   <select name="inv_content" id="ECS_INVCONTENT" <?php if ($this->_var['order']['need_inv'] != 1): ?>disabled="true"<?php endif; ?>  onchange="changeNeedInv()"  class="InBorderTwo">
  ...
  <tr>
   ...
   <td bgcolor="#ffffff"><textarea name="postscript" cols="80" rows="3" id="postscript" class="InBorderTwo"><?php echo htmlspecialchars($this->_var['order']['postscript']); ?></textarea></td>
  </tr>
...
<div class="goodsTitle blank"><?php echo $this->_var['lang']['fee_total']; ?></div>
 <?php echo $this->fetch('library/order_total.lbi'); ?>
  <div align="center" style="margin:8px auto;">
  <input type="image" src="themes/EnTemplate/images/bnt_subOrder.gif" />
...
<div class="Goodpromotion">
 <div class="f14b tc"><?php echo $this->_var['lang']['remember_order_number']; ?>：<font class="a"><?php echo $this->_var['order']['order_sn']; ?></font></div>
...
<div class="clearfix">
 <div class="step_login f_l"  style="width:420px;">
  <h4><?php echo $this->_var['lang']['label_login']; ?></h4>
 <form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
  <table width="100%" border="0" cellpadding="5" cellspacing="0">
     <tr>
      <td width="30%" align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['username']; ?></td>
      <td width="70%" bgcolor="#ffffff"><input name="username" type="text" class="InBorderTwoTwo" id="username" /></td>
     </tr>
     <tr>
      <td align="right" bgcolor="#ffffff" valign="top"><?php echo $this->_var['lang']['password']; ?></td>
      <td bgcolor="#ffffff">
      <input name="password" class="InBorderTwo" type="password" />
     ...
     <tr>
      ...
      <td bgcolor="#ffffff"><input type="text" size="8" name="captcha" class="InBorderTwo" />
 ...
 <div class="step_login f_r" style="width:420px;">
 <h4 class="h4bg"><?php echo $this->_var['lang']['label_regist']; ?></h4>
<form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
  <table width="100%" border="0" cellpadding="5" cellspacing="0" >
   <tr>
    ...
    <td bgcolor="#ffffff"><input name="username" type="text" class="InBorderTwo" id="username" onblur="is_registered(this.value);" /><br />
<span id="username_notice" style="color:#FF0000"></span></td>
   </tr>
   <tr>
    <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['email_address']; ?></td>
    <td bgcolor="#ffffff"><input name="email" type="text" class="InBorderTwo" id="email" onblur="checkEmail(this.value);" /><br />
<span id="email_notice" style="color:#FF0000"></span></td>
   </tr>
   <tr>
    <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['password']; ?></td>
    <td bgcolor="#ffffff"><input name="password" class="InBorderTwo" type="password" id="password1" onblur="check_password(this.value);" onkeyup="checkIntensity(this.value)" /><br />
<span style="color:#FF0000" id="password_notice"></span></td>
   </tr>
   <tr>
    <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['confirm_password']; ?></td>
    <td bgcolor="#ffffff"><input name="confirm_password" class="InBorderTwo" type="password" id="confirm_password" onblur="check_conform_password(this.value);" /><br />
