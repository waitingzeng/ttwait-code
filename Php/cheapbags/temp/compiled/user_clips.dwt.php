...
<?php echo $this->fetch('library/ur_here.lbi'); ?>
 ...
 <font class="PriceTwo"><?php echo $this->_var['info']['username']; ?></font> <?php echo $this->_var['lang']['welcome_to']; ?> <?php echo $this->_var['info']['shop_name']; ?>！<br /><br />
 ...
 <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()" style="color:#006bd0;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
  <?php endif; ?>
  <div class="us_notice">
  <img src="themes/EnTemplate/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
  </div>
 ...
 <?php echo $this->_var['lang']['your_integral']; ?>:<font class="PriceTwo"><?php echo $this->_var['info']['integral']; ?></font><br />
 </div>
...
?>
 ...
 <?php echo $this->_var['lang']['last_month_order']; ?><font class="PriceTwo"><?php echo $this->_var['info']['order_count']; ?></font><?php echo $this->_var['lang']['order_unit']; ?><br />
...
?>
 ...
 <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onsubmit="return submitMsg()">
  ...
  <tr>
   ...
   <td>
   <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/EnTemplate/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
   <input name="msg_type" type="hidden" value="5" />
   <input name="order_id" type="hidden" value="<?php echo $this->_var['order_info']['order_id']; ?>" class="InBorder" />
   </td>
  </tr>
  <?php else: ?>
  <tr>
  ...
  <tr>
   ...
   <td><input name="msg_title" type="text" size="30" class="InBorder" /></td>
  </tr>
  <tr>
   <td align="right" valign="top"><?php echo $this->_var['lang']['message_content']; ?>：</td>
   <td><textarea name="msg_content" cols="50" rows="4" wrap="virtual" class="InBorder"></textarea></td>
  </tr>
  <tr>
   <td align="right"><?php echo $this->_var['lang']['upload_img']; ?>：</td>
   <td><input type="file" name="message_img"  size="45"  class="InBorder" /></td>
  </tr>
  <tr>
   <td>&nbsp;</td>
...
?>
 <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/EnTemplate/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <?php else: ?>
...
<div class="us_contentBox">
 ...
 <tr>
  ...
  <td bgcolor="#ffffff">
   <select name="need_image" id="need_image" class="InBorder">
 ...
 <tr>
  ...
  <td bgcolor="#ffffff"><input name="goods_num" type="text" id="goods_num" value="6" class="InBorder" /></td>
 </tr>
 <tr>
  <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['label_arrange']; ?></td>
  <td bgcolor="#ffffff"><select name="arrange" id="arrange" class="InBorder">
 ...
 <tr>
   ...
   <td bgcolor="#ffffff"><input name="rows_num" type="text" id="rows_num" value="1" class="InBorder" /></td>
 </tr>
 <tr>
  <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['label_charset']; ?></td>
  <td bgcolor="#ffffff"><select name="charset" id="charset" class="InBorder">
 ...
 <tr>
  <td colspan="2" align="center" bgcolor="#ffffff">
  <textarea name="code" cols="80" rows="5" id="code" class="InBorder"></textarea>
  </td>
 </tr>
 </table>
 </form>
...
<div class="us_contentBox">
 ...
 <tr>
  ...
  <td bgcolor="#ffffff"><input name="number" type="text" value="<?php echo $this->_var['info']['goods_number']; ?>" class="InBorder" /></td>
 </tr>
 <tr>
  <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['describe']; ?>:</td>
  <td bgcolor="#ffffff"><textarea name="desc" cols="50" rows="5" wrap="virtual" class="InBorder"><?php echo htmlspecialchars($this->_var['info']['goods_desc']); ?></textarea>
  </td>
 </tr>
 <tr>
  <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['contact_username']; ?>:</td>
  <td bgcolor="#ffffff"><input name="linkman" type="text" value="<?php echo htmlspecialchars($this->_var['info']['consignee']); ?>" size="25"  class="InBorder"/>
  </td>
 </tr>
 <tr>
  <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['email_address']; ?>:</td>
  <td bgcolor="#ffffff"><input name="email" type="text" value="<?php echo htmlspecialchars($this->_var['info']['email']); ?>" size="25" class="InBorder" /></td>
 </tr>
 <tr>
  <td align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['contact_phone']; ?>:</td>
  <td bgcolor="#ffffff"><input name="tel" type="text" value="<?php echo htmlspecialchars($this->_var['info']['tel']); ?>" size="25" class="InBorder" /></td>
 </tr>
 <tr>
