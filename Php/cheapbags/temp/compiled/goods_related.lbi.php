...
<h2><?php echo $this->_var['lang']['releate_goods']; ?></h2>
</div>
...
?>
 <div class="goodsbox">
  ...
  <?php if ($this->_var['releated_goods_data']['promote_price'] != 0): ?>
   <?php echo $this->_var['lang']['promote_price']; ?><b class="PriceTwo"><?php echo $this->_var['releated_goods_data']['formated_promote_price']; ?></b><br />
  <?php else: ?>
  <?php echo $this->_var['lang']['shop_price']; ?><b class="PriceTwo"><?php echo $this->_var['releated_goods_data']['shop_price']; ?></b><br />
  <?php endif; ?>
 </div>
