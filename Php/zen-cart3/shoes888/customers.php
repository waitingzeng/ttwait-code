...
<?php
      ...
      if ($error == false) {
		...
		if($customers_password){
			$sql_data_array['customers_password'] = zen_encrypt_password($customers_password);
		}
		#TTwait Add End
...
<?php } ?>
      ...
      <!--#TTwait Add -->
      <tr>
        <td class="formAreaTitle">Change Password</td>
      </tr>
      <tr>
        <td class="formArea"><table border="0" cellspacing="2" cellpadding="2">
          <tr>
            ...
            <td class="main">
<?php
    echo zen_draw_input_field('customers_password', '', zen_set_field_length(TABLE_CUSTOMERS, 'customers_password', 50), false);
?></td>
          </tr>
      </table></td>
      </tr>
