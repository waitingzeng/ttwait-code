 ...
 */
  ...
  class order {
    ...
    function query($order_id) {
      ...
      $index = 0;
      #TTwait Change
      $orders_products = $db->Execute("select orders_products_id, products_id, products_name, products_model,products_image,
...
// convert quantity to proper decimals - account history
        ...
        #TTwait Add
        $this->products[$index]['link'] = '/product_info.php?products_id=' . $orders_products->fields['products_id'];
