...
// find template or default file
  function zen_get_file_directory($check_directory, $check_file, $dir_only = 'false') {
    ...
    #TTwait Add
    if (SITE_DOMAINK_KEY && file_exists($check_directory . $template_dir . '/' . SITE_DOMAIN_KEY . '/' . $zv_filename)) {
      $zv_directory = $check_directory . $template_dir . '/' . SITE_DOMAIN_KEY . '/';
    }
    #TTwait Add End
    elseif (file_exists($check_directory . $template_dir . '/' . $zv_filename)) {
