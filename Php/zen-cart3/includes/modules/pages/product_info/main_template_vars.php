 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name,
                  ...
                  p.products_discount_type, p.products_discount_type_from, p.products_sort_order, p.products_price_sorter, p.products_sizelist
...
// get attributes
	...
	#TTwait add
    $products_sizelist = $product_info->fields['products_sizelist'];
    if($products_sizelist){
		require(DIR_WS_MODULES . zen_get_module_directory('attributes_ttwait'));
    }
    #TTwait add end
