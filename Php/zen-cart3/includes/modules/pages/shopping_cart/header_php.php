    ...
    foreach ($products[$i]['attributes'] as $option => $value) {
      ...
      if($option == 1){
      	if($products_options_name_1 == ''){
	      	...
	      	$products_options_name_1 = $attributes_values->fields['products_options_name'];
      	}
        $attrArray[$option]['products_options_name'] = $products_options_name_1;
        
        
        $attrArray[$option]['options_values_id'] = $value;
        $attrArray[$option]['products_options_values_name'] = zen_output_string_protected($products_sizelist[$products_id[0]][$value]) ;
        $attrArray[$option]['options_values_price'] = 0;
        $attrArray[$option]['price_prefix'] = 0;
