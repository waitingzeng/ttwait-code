...
// added defines for header alt and text
  ...
  define('HEADER_SALES_TEXT', '<br/><span>Email:&nbsp;&nbsp;&nbsp;<a href="mailto:'.STORE_OWNER_EMAIL_ADDRESS.'">'.STORE_OWNER_EMAIL_ADDRESS.'</a>&nbsp;&nbsp;MSN:&nbsp;<a href="msnim:add?contack='.MSN.'">'.MSN.'</a><br/><br/>');
