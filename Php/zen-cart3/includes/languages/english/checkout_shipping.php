...
define('TEXT_ENTER_SHIPPING_INFORMATION', 'Delivered by express:EMS/UPS/TNT/DHL<br/>
After delivering,we will tell you the tracking no,and you can check the tracking informations online.<br/><span style="color:red"> shipping costs are free if your order is over $120;if less than $120,you need to pay $20 extra to cover shipping costs.</span>');
