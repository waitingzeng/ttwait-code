...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Template designed by <a href="http://www.sagefish.com/" target="_blank">Sage Fish.com</a>.&nbsp;Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
...
// information box text in sideboxes/information.php
  ...
  define('BOX_INFORMATION_PRIVACY', 'About Us');
  define('BOX_INFORMATION_CONDITIONS', 'FAQ');
...
// cart contents
  ...
  define('PRODUCTS_ORDER_QTY_TEXT','Input the quantity you need: ');
...
// extra product listing sorter
  ...
  define('DEFAULT_PRODUCT_INFO_DESCRIPTION', '');
///////////////////////////////////////////////////////////
