...
foreach ($links as $name=>$link) {
	$content .= '<div class="sideBoxContent centeredContent"><a href="'.$link.'" target="_blank"><img src="images/links/' . strtolower($name) .'.gif" alt="'.$name.'" title="'.$name.'" width="100" /></a></div>';
}
?>