...
<?php
  ...
  ?>
    <tr>
        ...
        <td class="accountProductDisplay"> <a href="<?php echo $order->products[$i]['link']; ?>"><span id="cartImage" class="back"><?php echo $order->products[$i]['image']; ?></span><span id="cartProdTitle"><?php echo $order->products[$i]['name']; ?></span></a>
        <?php 
