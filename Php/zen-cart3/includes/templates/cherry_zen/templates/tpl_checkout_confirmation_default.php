...
<?php for ($i=0, $n=sizeof($order->products); $i<$n; $i++) { ?>
        <tr class="<?php echo $order->products[$i]['rowClass']; ?>">
          ...
          <td class="cartProductDisplay"><a href="<?php echo $order->products[$i]['link']; ?>"><span id="cartImage" class="back"><?php echo $order->products[$i]['image']; ?></span><span id="cartProdTitle"><?php echo $order->products[$i]['name']; ?></span></a>
