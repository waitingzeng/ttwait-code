...
<?php }else{
	require($template->get_template_dir('/tpl_product_info_display_description.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_product_info_display_description.php');
} ?>
