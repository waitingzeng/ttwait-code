...
<form method="post" id="wpr_new">
	...
	<table class="addt" width="100%">
		...
		<tr>
			...
			<!--Tooltip--><a class="tooltip" href="#">?<span><?php _e('This custom field will be added to every post. Premium templates often use custom fields to populate thumbnails but there are many other possible uses as well.<br/><br/><b>Available Value Tags</b><br/>{keyword}<br/>{image}<br/>{video}<br/>{asin}<br/>{thumbnail}<br/>{amazonthumbnail}<br/>{youtubethumbnail}<br/>{flickrimage}<br/>{rssimage}<br/>(only if the module is used in the template!)<br/><br/><strong>Use the "+" button to add an additional custom field.</strong>',"wprobot") ?></span></a><br/>
