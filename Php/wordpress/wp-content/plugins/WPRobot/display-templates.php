<?php
$tags["amazon"] = "{title}, {keyword}, {url}, {link}, {description}, {features}, {thumbnail}, {rating}, {avgrating}, {reviewsnum}, {buynow-big}, {buynow-ger}, {buynow}, {listprice}, {price}, {reviews}, {smallimage}, {mediumimage}, {largeimage}";
...
$tags["pressrelease"] = "{title}, {keyword}, {url}, {pressrelease}";
$tags["commissionjunction"] = "{title}, {keyword}, {url}, {description}, {thumbnail}, {price}, {currency}, {saleprice}, {listprice}, {advertiser}, {instock}";
