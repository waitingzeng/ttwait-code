...
package com.heptafish.mapeditor.events
{
	...
	public class MapEditorEvent extends Event
	{
		...
		private var _userNodeRow:int;
		private var _userNodeCol:int;
		
		private var _isUserNode:Boolean;
		...
		public function get isUserNode():Boolean{
			return _isUserNode;
		}
		
		public function set isUserNode(val:Boolean):void{
			_isUserNode = val;
		}
		
		public function get userNodeRow():int{
			return _userNodeRow;
		}
		
		public function set userNodeRow(val:int):void{
			_userNodeRow = val;
		}
		
		public function get userNodeCol():int{
			return _userNodeCol;
		}
		
		public function set userNodeCol(val:int):void{
			_userNodeCol = val;
		}
